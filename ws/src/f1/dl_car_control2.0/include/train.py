...
if __name__=="__main__":
    ...
    # Base Directory
    path_to_data = []
    path_to_data.append(CSV_PATH + '/Hard_cases_NODIZZY')
    path_to_data.append(CSV_PATH + '/Hard_cases')
    
    path_to_data.append(CSV_PATH + '/Many_curves_Dizy')
    path_to_data.append(CSV_PATH + '/Many_Curves_E2')
    
    path_to_data.append(CSV_PATH + '/Hard_cases_NODIZZY')
    path_to_data.append(CSV_PATH + '/Hard_cases')
    
    path_to_data.append(CSV_PATH + '/Montmelo_Dizy_1')
    path_to_data.append(CSV_PATH + '/Montmelo_Dizy_180')
    path_to_data.append(CSV_PATH + '/Montmelo_E2')
    path_to_data.append(CSV_PATH + '/Montmelo_E2_2')
    path_to_data.append(CSV_PATH + '/Montmelo_E2')
    path_to_data.append(CSV_PATH + '/Montmelo_E2_2')
    path_to_data.append(CSV_PATH + '/Montmelo_E2_2')
    ...
    # path_to_data.append(CSV_PATH + '/Montreal_Dizy_1')
    # path_to_data.append(CSV_PATH + '/Montreal_E2')
    # path_to_data.append(CSV_PATH + '/Montreal_E2_2')
    # path_to_data.append(CSV_PATH + '/Montreal_E2')
    # path_to_data.append(CSV_PATH + '/Montreal_E2_2')
    # path_to_data.append(CSV_PATH + '/Montreal_E2_2')
    ...
    preprocess = 'crop' + 'afine'#+ 'norm' + 'afine' 
